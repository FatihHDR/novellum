    ...
    <section class="review-hero relative min-h-[70vh] flex items-center justify-center overflow-hidden pt-16">
        ...
        <div class="absolute inset-0 opacity-10">
            <div class="absolute top-0 left-0 w-full h-full"
                style="background-image: radial-gradient(circle at 2px 2px, #D4A276 1px, transparent 0); background-size: 40px 40px;">
            </div>
        </div>

        <!-- Floating Elements -->
        <div class="parallax-element absolute top-20 left-10 w-3 h-3 bg-[#D4A276] rounded-full"></div>
        <div class="parallax-element absolute top-40 right-20 w-2 h-2 bg-[#D4A276] rounded-full"
            style="animation-delay: 2s;"></div>
        <div class="parallax-element absolute bottom-32 left-1/3 w-1.5 h-1.5 bg-[#D4A276] rounded-full"
            style="animation-delay: 4s;"></div>

        <div class="relative z-10 text-center px-6 max-w-4xl mx-auto">
            <div class="mb-8">
                <span
                    class="inline-block px-6 py-3 text-sm font-medium text-[#D4A276] bg-[#D4A276]/10 rounded-full border border-[#D4A276]/20 backdrop-blur-sm">
            ...
            <p class="text-xl md:text-2xl text-[#4A4A4D] mb-10 max-w-3xl mx-auto leading-relaxed">
                Explore our comprehensive collection of literary criticism, from contemporary fiction to timeless
                classics
            </p>
            ...
            <div class="relative max-w-2xl mx-auto mb-8">
                ...
                <input type="text" placeholder="Search reviews, authors, or books..."
    ...
    <section class="py-16 bg-[#1D1D1F]">
        <div class="container mx-auto px-6 max-w-7xl">
            <div class="flex flex-wrap items-center justify-center gap-4 mb-12">
                <button
                    class="category-filter active px-6 py-3 rounded-full text-sm font-medium bg-[#D4A276] text-[#1D1D1F]">
                    All Reviews
                </button>
                <button
                    class="category-filter px-6 py-3 rounded-full text-sm font-medium bg-[#2A2A2C] text-[#F5F5F0] border border-[#4A4A4D]">
                ...
                <div class="group">
                    <div class="relative overflow-hidden rounded-3xl review-card-unique transition-all duration-500">
                        <div class="lg:flex">
                            <!-- Book Cover -->
                            <div
                                class="lg:w-1/3 aspect-square lg:aspect-auto bg-gradient-to-br from-[#D4A276]/30 to-[#F5F5F0]/10 flex items-center justify-center">
                                <div
                                    class="w-48 h-64 bg-[#D4A276] rounded-lg flex items-center justify-center shadow-2xl">
                                    <div class="text-center">
                                        ...
                                        <div class="text-[#1D1D1F] font-serif font-bold text-xl mb-8">Maali Almeida
                                        </div>
                            ...
                            <div class="lg:w-2/3 p-8 lg:p-12">
                                <div class="flex items-center mb-6">
                                    <span
                                        class="px-4 py-2 text-xs font-medium bg-[#D4A276] text-[#1D1D1F] rounded-full mr-4">Editor's
                                        Choice</span>
                                    <span class="text-sm text-[#4A4A4D]">March 18, 2025</span>
                                    <div class="ml-auto flex items-center">
                                        <div class="flex mr-3">
                                            <svg class="w-5 h-5 rating-star filled" fill="currentColor"
                                                viewBox="0 0 20 20">
                                                <path
                                ...
                                <h3
                                    class="text-3xl md:text-4xl font-serif font-bold text-[#F5F5F0] mb-6 group-hover:text-[#D4A276] transition-colors">
                                ...
                                <p class="text-[#4A4A4D] leading-relaxed mb-8 text-lg">
                                    Shehan Karunatilaka's Booker Prize-winning novel is a tour de force that combines
                                    supernatural elements with biting social commentary. Through the journey of
                                    photographer Maali Almeida in the afterlife, the author crafts a narrative that is
                                    both deeply personal and universally resonant, offering profound insights into war,
                                ...
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center">
                                        <div
                                            class="w-12 h-12 bg-gradient-to-br from-[#D4A276] to-[#F5F5F0] rounded-full mr-4 flex items-center justify-center">
                ...
                <div class="grid md:grid-cols-2 xl:grid-cols-3 gap-8">
                    ...
                    <div class="group review-card">
                        <div class="review-card-unique rounded-2xl p-6 h-full">
                            <div
                                class="aspect-[3/4] bg-gradient-to-br from-[#D4A276]/20 to-[#F5F5F0]/10 rounded-xl mb-6 flex items-center justify-center">
                            ...
                            <div class="flex items-center justify-between mb-4">
                                <span
                                    class="px-3 py-1 text-xs font-medium bg-[#4A4A4D] text-[#F5F5F0] rounded-full">Contemporary
                                    Fiction</span>
                                <div class="flex items-center">
                                    <div class="flex mr-2">
                            ...
                            <h3
                                class="text-xl font-serif font-bold text-[#F5F5F0] mb-3 group-hover:text-[#D4A276] transition-colors">
                            ...
                            <p class="text-sm text-[#F5F5F0] review-excerpt leading-relaxed mb-6">
                                A brilliant exploration of friendship, creativity, and the video game industry. Zevin
                                crafts a narrative that spans decades, examining how art, ambition, and human connection
                            ...
                            <div class="flex items-center justify-between">
                                <div class="flex items-center">
                                    <div
                                        class="w-8 h-8 bg-[#D4A276] rounded-full mr-2 flex items-center justify-center">
                    ...
                    <div class="group review-card">
                        <div class="review-card-unique rounded-2xl p-6 h-full">
                            ...
                            <div class="flex items-center justify-between mb-4">
                                <span
                                    class="px-3 py-1 text-xs font-medium bg-[#4A4A4D] text-[#F5F5F0] rounded-full">Classic
                                    Literature</span>
                                <div class="flex items-center">
                                    <div class="flex mr-2">
                                        <svg class="w-4 h-4 rating-star filled" fill="currentColor" viewBox="0 0 20 20">
                            ...
                            <p class="text-sm text-[#F5F5F0] review-excerpt leading-relaxed mb-6">
                                A masterpiece that redefined literature through magical realism. Márquez weaves a
                                multigenerational saga that captures the essence of Latin American history while
                                exploring universal themes of love, loss, and the cyclical nature of time.
                            </p>
                    ...
                    <div class="group review-card">
                        <div class="review-card-unique rounded-2xl p-6 h-full">
                            ...
                            <div class="flex items-center justify-between mb-4">
                                <span
                                    class="px-3 py-1 text-xs font-medium bg-[#4A4A4D] text-[#F5F5F0] rounded-full">Poetry</span>
                                <div class="flex items-center">
                                    <div class="flex mr-2">
                                        <svg class="w-4 h-4 rating-star filled" fill="currentColor" viewBox="0 0 20 20">
                                            <path
                            ...
                            <p class="text-sm text-[#F5F5F0] review-excerpt leading-relaxed mb-6">
                                A powerful collection that interrogates colonial violence while celebrating Indigenous
                                resilience and love. Diaz's verses are both politically charged and deeply personal,
                                creating a unique voice in contemporary American poetry.
                            </p>
    ...
    <section class="py-20 bg-[#1D1D1F] border-t border-[#4A4A4D]">
        <div class="container mx-auto px-6 max-w-4xl text-center">
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center max-w-md mx-auto">
                ...
                <button
                    class="px-8 py-4 bg-[#D4A276] text-[#1D1D1F] font-semibold rounded-full hover:bg-[#F5F5F0] transition-colors">
                    Subscribe
                </button>
            </div>
        </div>
